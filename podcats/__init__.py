...
class Episode(object):
    ...
    def __init__(self, filename, relative_dir, root_url, title_mode='default'):
...
class Channel(object):
    ...
    def __init__(self, root_dir, root_url, host, port, title, link, debug=False, folder_path=None, title_mode='default'):
        ...
        for root, _, files in os.walk(walk_dir):
            ...
            for fn in files:
                ...
                if is_audio_file(filepath):
                    yield Episode(filepath, relative_dir, self.root_url, self.title_mode)
